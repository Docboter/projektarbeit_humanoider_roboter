# Graph Report - projektarbeit_humanoider_roboter  (2026-08-26)

## Corpus Check
- 341 files · ~931,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5693 nodes · 9743 edges · 346 communities (323 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 411 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `450f911c`
...
3. `G1Dex3BlockstackEnv` - 59 edges
...
- `main()` --references--> `LoopFunc`  [INFERRED]
  data/unitree_ros/unitree_ros_to_real/unitree_legged_sdk/example/example_torque.cpp → data/unitree_ros/unitree_ros_to_real/unitree_legged_sdk/include/unitree_legged_sdk/loop.h
- `main()` --references--> `LoopFunc`  [INFERRED]
...
### Community 0 - "handle"
Cohesion: 0.07
Nodes (32): load_bytes(), string_caster, UTF_N, none, ensure(), args_proxy, delattr(), error_already_set() (+24 more)

### Community 1 - "T"
Cohesion: 0.09
Nodes (28): arg::operator=(), arg_v, descr, value, cast(), cast_impl(), cast_op(), cast_ref() (+20 more)

### Community 2 - "type_caster_generic"
Cohesion: 0.12
Nodes (11): caster_t, load(), type_caster_generic, cpptype, type_caster_generic, typeinfo, value, type_caster<std::reference_wrapper<type>> (+3 more)

### Community 3 - "class.h"
Cohesion: 0.08
Nodes (46): add_patient(), clear_instance(), clear_patients(), deregister_instance(), deregister_instance_impl(), enable_buffer_protocol(), enable_dynamic_attributes(), get_fully_qualified_tp_name() (+38 more)
...
Cohesion: 0.06
Nodes (43): any_of<is_holder<T>, is_subtype<T>, is_base<T>>, add_base(), call_operator_delete(), create_extension_module(), def_submodule(), get_overload(), get_override(), get_type_overload() (+35 more)
...
### Community 10 - "pybind11_fail"
Cohesion: 0.08
Nodes (20): PYBIND11_NOINLINE, pybind11_fail(), embedded_module, finalize_interpreter(), initialize_interpreter(), scoped_interpreter, is_valid, exception (+12 more)
...
Cohesion: 0.08
Nodes (21): G1Dex3BlockstackEnv, Any, DirectRLEnv, Tensor, Ordnet Joint-Namen auf Isaac-Lab-interne Indices ab., Setzt das absolute Positions-Target EINMALIG vor den Physics-Sub-Steps.…, Wendet das in _pre_physics_step berechnete Target an (render_interval-mal)., Reward je nach cfg.reward_mode. "binary" (Default): spärlicher 0/1-Success-… (+13 more)
...
Cohesion: 0.09
Nodes (10): sequence, set, tuple, reserve_maybe(), item_accessor, list_accessor, sequence_accessor, sequence_iterator (+2 more)
...
### Community 25 - "list"
Cohesion: 0.12
Nodes (12): copy_move_policies, list, _values, bind_ConstructorStats(), m, PYBIND11_MODULE(), test_initializer::test_initializer(), m (+4 more)

### Community 26 - "msg"
Cohesion: 0.06
Nodes (39): msg(), Sanitize messages and add custom failure explanation, test_inheritance(), test_inheritance_init(), test_instance(), test_reentrant_implicit_conversion_failure(), Tests nested (e.g. C++ -> Python -> C++) exception handling, test_custom() (+31 more)
...
Cohesion: 0.15
Nodes (19): broadcast_trivial, index_sequence, apply_broadcast(), apply_trivial(), Func, remove_reference_t, Return, return_value_policy (+11 more)
...
Cohesion: 0.09
Nodes (19): PolicyClient, build_obs(), MsgSerializer, PolicyClient, ndarray, Setzt den Server-internen Policy-State zurück (neue Episode)., Sendet eine Observation (im Gr00tSimPolicyWrapper-Format) und empfängt Action-…, Baut das Observation-Dict im Gr00tSimPolicyWrapper flat-key Format auf. Args:… (+11 more)
...
Cohesion: 0.14
Nodes (13): CopyOnlyInt, value, empty, instance_, lacking_copy_ctor, lacking_move_ctor, MoveOnlyInt, value (+5 more)
...
Cohesion: 0.13
Nodes (30): artifact_validation_errors(), _candidate_pick(), infer_expected_first_pick(), _longest_true_run(), manifest_compatibility_errors(), mark_episode_existing(), Any, ndarray (+22 more)

### Community 42 - "cast.h"
Cohesion: 0.06
Nodes (43): all_of, always_construct_holder, value, get_thread_state_unchecked(), false_type, pair, PyThreadState, T2 (+35 more)

### Community 43 - "detail/common.h"
Cohesion: 0.04
Nodes (56): bool_constant, bools, builtin_exception, set_error, constexpr_first(), constexpr_last(), deferred_type, exactly_one (+48 more)
...
### Community 45 - "dtype"
Cohesion: 0.11
Nodes (12): array_descriptor_proxy(), compare_buffer_info<T, detail::enable_if_t<detail::is_pod_struct<T>::value>>, dtype, PyObject, npy_format_descriptor, npy_format_descriptor_name, npy_format_descriptor<T, enable_if_t<satisfies_any_of<T, std::is_arithmetic, is_complex>::value>>, value (+4 more)
...
Cohesion: 0.19
Nodes (26): append_observation(), configure_geometry(), dataset_paths(), episode_path(), finalize_dataset(), frame_from_obs(), load_episode(), main() (+18 more)
...
### Community 61 - "object"
Cohesion: 0.07
Nodes (22): PyObject, object_api<Derived>::operator()(), eval(), eval_file(), exec(), array_t(), bool_, borrowed_t (+14 more)

### Community 62 - "cpp_function"
Cohesion: 0.06
Nodes (34): postcall(), precall(), add_class_method(), add_object(), all_type_info_get_cache(), cpp_function, enum_, enum_base (+26 more)
...
Nodes (23): all_type_info_populate(), name, detail::type_info *get_type_info(const std::type_index &tp,
                                                          bool throw_if_missing = false)(), get_global_type_info(), get_local_type_info(), get_object_handle(), get_type_handle(), instance (+15 more)
...
Cohesion: 0.08
Nodes (19): async_module, return_value_policy, RValueCaster, test_initializer, type_caster<RValueCaster>, m, TEST_SUBMODULE(), m (+11 more)
...
Cohesion: 0.04
Nodes (45): Antwort (runs/20260808/26): der Griff scheitert auch ohne Modell, Der Test ohne Platzierungs-Annahme: `GRASP_MODE=hold`, Der Vergleich mit Lauf 31 (gleiches Zeitfenster, alter Checkpoint), Diagnose-Chronik — Sim- und RL-Läufe 08–52, Die eigentliche Messung (runs/20260808/25) — die Hand ist am Würfel, Die Würfel „springen" im Video — das ist der Test, kein Bug, Ergebnis (`runs/20260808/19`) — der Gap sitzt in der Belichtung, nicht in der Geometrie, Ergebnis (`runs/20260808/21`) — halb gemessen, und die Hälfte war schon gelöst (+37 more)
...
### Community 85 - "unpacking_collector"
Cohesion: 0.11
Nodes (18): collect_arguments(), detail::type_info* get_type_info(PyTypeObject *type)(), policy, string, Tuple, loader_life_support, make_tuple(), process() (+10 more)
...
Cohesion: 0.09
Nodes (22): instance, pair, PyObject, unordered_set, internals, default_metaclass, direct_conversions, inactive_override_cache (+14 more)
...
### Community 96 - "Loop"
Cohesion: 0.11
Nodes (16): Callback, main(), string, Loop, _bind_cpu_flag, _bindCPU, entryFunc, functionCB (+8 more)
...
Cohesion: 0.08
Nodes (54): apply_homography(), build_calibration(), combine_camera_estimates(), coverage_defects(), deterministic_episode_split(), episode_diagnostic_pixels(), _finite_statistic(), fit_homography() (+46 more)
...
Cohesion: 0.04
Nodes (57): ArrayStruct, a, b, c, d, ComplexStruct, cdbl, cflt (+49 more)
...
Cohesion: 0.09
Nodes (38): accept_yaw(), Ist der Gierwinkel dieses Würfels belastbar? Entscheidend ist, dass **beide…, layout_with(), load_yaw_to_quat(), measure(), 1° und 89° liegen 2° auseinander, ihr Mittel ist 0° — nicht 45°., ``render_cotrain_dataset`` importiert Isaac beim Laden — also nur die Funktion…, Der Rückfall muss exakt das alte Verhalten sein, nicht beinahe. (+30 more)
...
Cohesion: 0.05
Nodes (56): accessor, add(), append(), arg, arg_v, arrow_proxy, value, as_unsigned() (+48 more)
...
Cohesion: 0.18
Nodes (25): color_mask(), draw_markers(), load_png(), load_video_frame(), locate_cubes(), main(), mean_yaw_deg(), Path (+17 more)
...
Cohesion: 0.12
Nodes (11): cast(), Func, return_value_policy, "Execution frame", "Import error handling", "Pass classes and data between modules defined in C++ and Python", "Reload module from file", "Restart the interpreter" (+3 more)
...
### Community 132 - "unitree_legged_sdk.h"
Cohesion: 0.12
Nodes (9): string, m, PYBIND11_MODULE(), m, string, noisy_funct_dual(), noisy_function(), TEST_SUBMODULE() (+1 more)

### Community 133 - "dump_camera_poses.py"
Cohesion: 0.17
...
Cohesion: 0.17
Nodes (13): A, B, m, pair, T, NonZeroIterator, ptr_, NonZeroSentinel (+5 more)
...
### Community 141 - "Alloc"
Cohesion: 0.21
Nodes (12): Alloc, array_caster, Type, list_caster, type_caster<std::array<Type, Size>>, type_caster<std::deque<Type, Alloc>>, type_caster<std::list<Type, Alloc>>, type_caster<std::valarray<Type>> (+4 more)
...
Cohesion: 0.16
Nodes (13): LowCmd, LowState, Custom, cmd, dt, motiontime, RobotControl, safe (+5 more)

### Community 148 - "reconstruct_cube_poses.py"
Cohesion: 0.25
Nodes (22): ArgumentParser, add_selection_args(), camera_from_record(), camera_record(), data_path(), format_dataset_path(), load_video_frames(), main() (+14 more)
...
### Community 166 - "type_caster_base"
Cohesion: 0.21
...
Cohesion: 0.16
Nodes (23): evaluate_hand(), hand_measurement(), load_episode(), load_frames(), main(), pick_anchor(), ndarray, Path (+15 more)
...
Cohesion: 0.10
Nodes (19): 1. Das Problem: Isaac Sim braucht RT-Cores, 2. GPU-Landschaft auf GWDG, 3. Die Lösung: `jupyter.hpc.gwdg.de` (RTX 5000), 4. Konsequenz für die Zwei-Container-Architektur, 5. Empfohlenes Vorgehen, Caveats, GPU-Eignung für die Isaac-Sim-Closed-Loop-Sim auf GWDG, Quellen (+11 more)
...
### Community 189 - "top_face_blob"
Cohesion: 0.29
Nodes (9): action_sha256(), best_top_face_detection(), Select the largest, least occluded top-face detection in early frames., Return a stable hash of the unchanged float32 action tensor., Return the bright upper cube face, falling back to the full color blob. WARNUNG…, top_face_blob(), test_action_hash_detects_any_value_change(), test_best_top_face_detection_uses_largest_stable_candidate() (+1 more)
...
### Community 192 - "PYBIND11_OVERRIDE"
Cohesion: 0.17
...
### Community 196 - "._force_camera_prim_orientations"
Cohesion: 0.18
...
### Community 201 - "value_and_holder"
Cohesion: 0.20
Nodes (5): value_and_holder, index, inst, type, vh

### Community 202 - "Portabilität — das Repo auf einem fremden Rechner betreiben"
Cohesion: 0.12
Nodes (16): 1. Was sich geändert hat, 2.1 IKR-Server (Docker, `server_rl_run.sh`), 2.2 KISSKI (Apptainer + SLURM), 2.3 Checkliste, 2.4 Sim-Standalone-Image umbenannt (ehemals `sim-vastai`), 2. Migration — das alte Verhalten auf den eigenen Maschinen wiederherstellen, 3.1 Eigener GPU-Server (Docker) — Sim, Greif-Diagnose, RL, 3.2 Anderes KISSKI-Projekt (+8 more)

### Community 203 - "TEST_SUBMODULE"
Cohesion: 0.25
Nodes (7): callbacks, UnregisteredType, m, TEST_SUBMODULE(), m, TEST_SUBMODULE(), pytypes

### Community 204 - "load_impl"
Cohesion: 0.12
Nodes (15): copyable_holder_caster, holder, holder_type, type, unique_ptr, holder_helper, implicit_cast(), load_impl() (+7 more)
...
### Community 207 - "array_info<std::array<T, N>>"
Cohesion: 0.22
...
### Community 213 - "setup.py"
Cohesion: 0.33
Nodes (4): get_and_replace(), Prepare a temporary directory, cleanup when done, SDist, TemporaryDirectory()

### Community 214 - "test_layout_file_merge.py"
Cohesion: 0.29
Nodes (17): header_mismatch(), Was an einer vorhandenen layout.json nicht zum laufenden Aufruf passt (leer =…, extract_args(), make_dataset(), Namespace, Path, Zwei Bias-Werte in einer Datei sind nicht unterscheidbar — also gar nicht erst., --no-motion-onset heißt „nicht messen", nicht „löschen". Sonst macht ein… (+9 more)
...
Cohesion: 0.18
Nodes (14): Compare, map, set, unordered_map, unordered_set, Value, set_caster, type_caster<std::map<Key, Value, Compare, Alloc>> (+6 more)
...
### Community 222 - "instance::allocate_layout"
Cohesion: 0.40
Nodes (5): instance::allocate_layout(), PyObject_HEAD, instance_simple_holder_in_ptrs(), log2(), size_in_ptrs()

### Community 223 - "PinholeCamera"
Cohesion: 0.09
Nodes (23): G1Dex3CameraCfg, look_at_world_quat(), PinholeCamera, ndarray, quat_to_matrix(), Projektion und Rückprojektion für eine der weltfesten Kameras. Bildachsen in…, Eine der weltfesten Kameras aus der Konfiguration bauen. Nur die drei…, Weltpunkte (…,3) → Pixel (…,2) als (u, v). Punkte hinter der Kamera: NaN. (+15 more)
...
### Community 249 - "UnitreeJointController::init"
Cohesion: 0.67
...
Cohesion: 0.30
Nodes (11): episode_motion_onsets(), Ab welchem Frame sich jeder Würfel im Realvideo bewegt. Das ist die Grenze, bis…, _prepare(), Ein Farbverlauf, der genau ab ``onset`` um mehr als die Schwelle abweicht., Leere Videodateien anlegen und ``track_colors`` durch feste Spuren ersetzen., test_first_onset_is_the_earliest_reliable_cube(), test_missing_videos_do_not_invent_an_onset(), test_motion_onset_ignores_a_single_stray_frame() (+3 more)

### Community 269 - "test_numpy_vectorize.cpp"
Cohesion: 0.50
...
### Community 273 - "TEST_SUBMODULE"
Cohesion: 0.50
Nodes (3): m, TEST_SUBMODULE(), union_

### Community 276 - "stl.h"
Cohesion: 0.16
Nodes (20): call(), cast(), forward_like(), return_value_policy, T, U, Variant, operator()() (+12 more)
...
Cohesion: 0.18
Nodes (8): eigen_encapsulate(), eigen_extract_stride, eigen_extract_stride<Eigen::Map<PlainObjectType, MapOptions, StrideType>>, eigen_extract_stride<Eigen::Ref<PlainObjectType, Options, StrideType>>, eigen_ref_array(), load(), type_caster<Type, enable_if_t<is_eigen_other<Type>::value>>, name
...
Cohesion: 0.15
Nodes (12): conditional_t, enable_if_t, size(), type_caster<unchecked_mutable_reference<T, Dim>>, unchecked_reference, data_, dims_, Dynamic (+4 more)
...
### Community 344 - "ndarray"
Cohesion: 0.10
Nodes (27): _draw_line(), draw_yaw_square(), _extent_across(), _fill_polygon(), largest_blob(), largest_component(), measure_yaw(), otsu_threshold() (+19 more)
...
### Community 421 - ".load"
Cohesion: 0.36
Nodes (5): type_list, load_alternative(), map_caster, variant_caster<V<Ts...>>, PyList_SET_ITEM

### Community 434 - "call"
Cohesion: 0.22
Nodes (10): call(), call_impl(), Func, Return, type_caster<void>, name, type_caster<void_type>, value (+2 more)
...
## Knowledge Gaps
- **1468 isolated node(s):** `compare_domain_gap.sh script`, `kisski_replay_submit.sh script`, `APPTAINER_CACHEDIR`, `APPTAINER_TMPDIR`, `kisski_robocasa_ref_submit.sh script` (+1463 more)
...
- **Why does `UnitreeJointController` connect `UnitreeJointController` to `unitree_legged_sdk.h`, `name_space`, `UnitreeJointController::update`, `convert.h`, `joint_controller.h`?**
...
- **Why does `PYBIND11_MODULE()` connect `unitree_legged_sdk.h` to `Time`?**
