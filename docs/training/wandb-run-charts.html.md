<!-- markitdown: auto-converted from /home/luca/coding/projektarbeit/projektarbeit_humanoider_roboter/docs/training/wandb-run-charts.html -->

# W&B-Verlauf · g1\_dex3\_blockstacking\_v1

Projekt `gr00t-g1-dex3` · Entity `projektarbeit_humanoider_roboter` · Run-ID `i6n1t613`
Node `ggpu177` (KISSKI) · 1× GPU · **Snapshot: 2026-06-02, ~20:47 UTC** — laufendes Training, nicht final.
