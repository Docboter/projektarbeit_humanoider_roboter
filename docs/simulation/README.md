...
| [inferenz-optimierung.md](inferenz-optimierung.md) | **ONNX/TensorRT + synchrones Kamerarendering.** Baut den N1.6-DiT auf der Ziel-GPU als TensorRT-Engine, prüft Aktionsparität und vergleicht den bisherigen Closed-Loop-Durchsatz automatisch mit dem schnellen Modus. Enthält die vollständigen IKR-Server-Kommandos. |
