...
| [diagnose-chronik.md](diagnose-chronik.md) | **Diagnose-Chronik (Läufe 08–34)** — chronologisches Protokoll aller Sim-/RL-Diagnoseläufe (Kamera-Fixes, Domain-Gap-Messläufe, Greif-Physik Lauf 29, `span`-Gate Lauf 32, `TUNE_VISUAL` im Closed Loop Lauf 34). Hierher zeigen die projektweiten „Lauf N"-Verweise. |
...
| 2026-08-08 → 14 | Diagnose-Läufe 08–34 (Kamera, Greif-Physik, `span`-Gate, `TUNE_VISUAL`) | [diagnose-chronik.md](diagnose-chronik.md) |
