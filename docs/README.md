...
| [weiterfuehrend/rl-anleitung.md](weiterfuehrend/rl-anleitung.md) | **RL-Bedienungsanleitung (operativ)** — Image bauen → BC-Checkpoint → vast.ai (RT-Core-GPU) → RL starten → überwachen → Checkpoints sichern; Smoke-Test + LIVE-CHECK-Punkte |
