...
#   sbatch --output=/pfad/logs/slurm-replay-%j.out --error=/pfad/logs/slurm-replay-%j.err <skript>
#SBATCH --output=logs/slurm-replay-%j.out
#SBATCH --error=logs/slurm-replay-%j.err
#SBATCH --export=ALL
