...
\TODO[Anzahl Trainingsschritte]~Trainingsschritte, aufgezeichnet mit \ac{wandb}.
...
Insgesamt wurden $n = \TODO[Episodenzahl pro Checkpoint]$~Episoden pro Checkpoint ausgewertet
...
\begin{figure}[htb]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      % Platzhalter-Daten:
      % Platzhalter-Werte (0) ersetzen durch echte Erfolgsraten:
      \addplot coordinates {(BS=8,0) (BS=32,0) (BS=64,0)};
    \end{axis}
  \end{tikzpicture}
